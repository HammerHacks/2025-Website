      ...
      <section className="text-center text-black" id="about">
        <div className="letter bg-white border border-gray-400 shadow-lg mx-auto mt-8 p-8 max-w-4xl relative slide-in">
          <h2 className="glowing-text text-3xl font-bold mb-4 slide-in">
            An Introduction to HammerHacks
          </h2>
          ...
          <p className="text-lg mt-4 slide-in">
            HammerHacks is a high school hackathon, a social coding marathon and
            competition where you can use technology to build your most creative
            ideas and share your project with other students. We invite all
            interested students from across the Hamilton-Wentworth Area to join
            us this winter for a day-long hackathon with plenty of opportunities
            to grow your skills.
          </p>
          <br />
          <p className="text-lg mt-4 slide-in">
            Join 100+ Hackers to collaborate and create unique solutions that
            push your skills to the limits, all while having fun and connecting
